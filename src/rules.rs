...
declare_rules! {
    ...
    sort_imports => { id: SORT_IMPORTS_RULE_ID, value: "sort-imports", path: "rules/imports/sort_imports.rs", config: crate::config::RuleConfig },
    ...
    sort_exports => { id: SORT_EXPORTS_RULE_ID, value: "sort-exports", path: "rules/exports/sort_exports.rs", config: crate::config::RuleConfig },
