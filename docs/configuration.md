...
| `explicit-return-type`       | `include-arrow-functions`, `include-class-methods`, `include-private`, `ignore-when-inferred` |
...
| `sort-exports`               | `groups`, `newlines-between`                                                                  |
| `sort-imports`               | `groups`, `newlines-between`, `internal-patterns`                                             |
